...
<section style="margin-top: 15px;">
    <article>
        ...
        <p><img width="18" height="18" src="https://nextcloud.com/wp-content/themes/next/assets/img/common/favicon.png?x53054" style="position: relative; top: 2px;"> NextCloud -&gt;&nbsp;<a href="https://cloud.subtlefu.ge" target="_blank">Cloud Storage</a></script></a></p>
        <p><img width="18" height="18" src="https://syncthing.net/img/favicon.png" style="position: relative; top: 2px;"> SyncThing -&gt;&nbsp;<a href="https://syncthing.subtlefu.ge" target="_blank">File Synchronization</a></script></a></p>
        <p style="">
            <img width="18" height="18" src="https://flood.subtlefu.ge/favicon.ico" style="position: relative; top: 4px;"> Flood -&gt;&nbsp;<a href="https://flood.subtlefu.ge"  target="_blank">rTorrent Web GUI</a></script></a>
        </p>
    </article>
</section>
...
<section style="">
    <article>
        ...
        <p><img width="18" height="18" src="https://jellyfin.subtlefu.ge/web/favicon.ico" style="position: relative; top: 2px;"> JellyFin -&gt;&nbsp;<a href="https://jellyfin.subtlefu.ge/" target="_blank">Movies & TV Media Server</a></script></a></p>

        <p style="">
            <img width="18" height="18" src="https://plex.subtlefu.ge/favicon.ico" style="position: relative; top: 4px;"> Plex -&gt;&nbsp;<a href="https://plex.subtlefu.ge/"  target="_blank">Movies & TV Media Server</a></script></a>
        </p>
        <p>
            <img width="18" height="18" src="https://emby.subtlefu.ge/favicon.ico" style="position: relative; top: 4px;"> Emby -&gt;&nbsp;<a href="https://emby.subtlefu.ge">>Movies & TV Media Server</a></script></a>

        </p>
        <p>
            <img width="18" height="18" src="https://ombi.subtlefu.ge/images/favicon/favicon.ico" style="position: relative; top: 4px;"> Ombi -&gt;&nbsp;<a href="https://ombi.subtlefu.ge/">Movies & TV Auto-Requester</a></script></a>
        </p>
        <p>
            <img width="18" height="18" src="https://sonarr.subtlefu.ge/favicon.ico" style="position: relative; top: 4px;"> Sonarr -&gt;&nbsp;<a href="https://sonarr.subtlefu.ge">TV Auto-Downloader</a></script></a>
        </p>
        <p>
            <img width="18" height="18" src="https://radarr.subtlefu.ge/favicon.ico" style="position: relative; top: 4px;"> Radarr -&gt;&nbsp;<a href="https://radarr.subtlefu.ge/">Movies Auto-Downloader</a></script></a>
        </p>
        <p>
            <img width="18" height="18" src="https://jackett.subtlefu.ge/favicon.ico" style="position: relative; top: 4px;"> Jackett -&gt;&nbsp;<a href="https://jackett.subtlefu.ge/">Private Tracker Indexer Proxy</a></script></a>
        </p>
    </article>
</section>
...
<section style="">
    <article>
        ...
        <p><img width="16" height="16" src="https://corbin.world/mirc-icon-19.png"> IRC -&gt;&nbsp;<span id="email">irc.subtlefu.ge</span></p>
        <p><img width="16" height="16" src="https://matrix.org/favicon-32x32.png?v=9c73e3e9f08bfca2a260df81aabb2fd4"> Matrix -&gt;&nbsp;<span id="email">subtlefu.ge</span></p>
        <p><img width="16" height="16" src="https://element.io/images/favicon.png" style="position: relative; top: 2px;"> Element -&gt;&nbsp;<a href="https://chat.subtlefu.ge" target="_blank">Matrix Web Client</a></script></a></p>

        <p style="">
            <img width="16" height="16" src="https://subtlefu.ge/irc/favicon.ico" style="position: relative; top: 4px;"> IRC -&gt;&nbsp;<a href="https://subtlefu.ge/irc/"  target="_blank">IRC Web Client</a></script></a>
        </p>
    </article>
</section>
...
<section style="">
    <article>
        ...
        <p>
            <img width="18" height="18" src="https://flarum.org/favicon-32x32.png?v=YAXePblQz9" style="position: relative; top: 4px;"> Flarum -&gt;&nbsp;<a href="https://flarum.subtlefu.ge">Web 2.0 Forum</a>

        </p>
        <p>
            <img width="18" height="18" src="https://www.discourse.org/a/img/favicon.ico" style="position: relative; top: 4px;"> Discourse -&gt;&nbsp;<a href="https://discourse.subtlefu.ge">Web 2.0 Forum</a>
        </p>
        <p>
            <img width="18" height="18" src="https://mastodon.social/favicon.ico" style="position: relative; top: 4px;"> Mastadon -&gt;&nbsp;<a href="https://mastadon.subtlefu.ge">Federated Twitter Alternative</a>

        </p>
        <p>
            <img width="18" height="18" src="https://nitter.net/favicon-16x16.png" style="position: relative; top: 4px;"> Nitter -&gt;&nbsp;<a href="https://nitter.subtlefu.ge">FOSS Twitter Frontend</a>
        </p>
        <p>
            <img width="18" height="18" src="https://lemmy.ml/pictrs/image/bhQ7ELa4oq.webp" style="position: relative; top: 4px;"> Lemmy -&gt;&nbsp;<a href="https://lemmy.subtlefu.ge">Federated Reddit Alternative</a>
        </p>
        <p>
            <img width="18" height="18" src="https://pixelfed.subtlefu.ge/img/favicon.png?v=2" style="position: relative; top: 4px;"> PixelFed -&gt;&nbsp;<a href="https://pixelfed.subtlefu.ge">Federated Instagram Alternative</a>
        </p>
        <p>
            <img width="18" height="18" src="https://joinpeertube.org/img/icons/favicon.png" style="position: relative; top: 4px;"> PeerTube -&gt;&nbsp;<a href="https://peertube.subtlefu.ge">Federated YouTube Alternative</a>
        </p>
        <p>
            <img width="18" height="18" src="https://invidious.fdn.fr/favicon-32x32.png?v=2abec5b6" style="position: relative; top: 4px;"> Invidious -&gt;&nbsp;<a href="https://invidious.subtlefu.ge">Federated YouTube Alternative</a>
        </p>
        <p>
            <img width="18" height="18" src="https://alltubedownload.net/img/favicon.png" style="position: relative; top: 4px;"> AllTubeDownload -&gt;&nbsp;<a href="https://alltube.subtlefu.ge">Tube Video Downloader</a>
        </p>
...
<section style="">
    <article>
        ...
        <p><img width="18" height="18" src="https://phppgadmin.subtlefu.ge/images/themes/default/Favicon.ico"> PHPPGAdmin -&gt;&nbsp;<a href="https://phppgadmin.subtlefu.ge">Postgres SQL Webmin</a></p>
        <p><img width="18" height="18" src="https://subtlefu.ge/phpmyadmin/favicon.ico"> PHPMyAdmin -&gt;&nbsp;<a href="https://phppgadmin.subtlefu.ge">MySQL SQL Webmin</a></p>
        <p><img width="18" height="18" src="data:image/x-icon;base64," style="position: relative; top: 2px;"> NetData -&gt;&nbsp;<a href="https://netdata.subtlefu.ge" target="_blank">NetData Server Stats</a></script></a></p>

        <p style="">
            <img width="18" height="18" src="https://gitea.io/images/favicon.png" style="position: relative; top: 4px;"> Gitea -&gt;&nbsp;<a href="https://gitea.subtlefu.ge">Self-Hosted Git GUI</a>
        </p>
        <p style="">
            <img width="18" height="18" src="https://cockpit.subtlefu.ge/cockpit/static/logo.png" style="position: relative; top: 4px;"> Cockpit -&gt;&nbsp;<a href="https://cockpit.subtlefu.ge">Server Webmin GUI</a>
        </p>
    </article>
</section>
